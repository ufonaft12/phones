            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="banner-block">
                        ...
                        <ul>
                            <li><i class="far fa-check-circle"></i>מחירים אטרקטיביים</li>
                            <li><i class="far fa-check-circle"></i>מגוון אשיר של מוצרים</li>
                            <li><i class="far fa-check-circle"></i>הספקהt מהירה</li>
                            <li><i class="far fa-check-circle"></i>מעבדה מקצועית</li>
                        </ul>
                        <a href="#" class="button btn-right">שירותי תיקונים</a>
                        <a href="#" class="button btn-left">שירותי תיקונים</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <a href="">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <g>
                                    ...
                                    <rect x="7" y="13.3"
                                          transform="matrix(0.4961 -0.8682 0.8682 0.4961 -6.5294 16.4655)"
                                          width="7.9" height="1.1"/>
                                </g>
                            </svg>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="content-wrapper">
                            <h3>הצהרת אמינות</h3>
                            <p>ורם איפסום דולור סיט אמט, קונסקטורר אדיפיסינג אלית גולר מונפרר סוברט לורם שבצק יהול, לכנוץ
                                בעריר גק ליץ, נולום ארווס סאפיאן - פוסיליס קוויס, אקווזמן לורם איפסום דולור סיט אמט,
                                קונסקטורר אדיפיסינג אלית. סת אלמנקום ניסי נון ניבאה. דס איאקוליס וולופטה דיאם. וסטיבולום אט
                                דולור, קראס אגת לקטוס וואל אאוגו וסטיבולום סוליסי טידום בעליק. נולום ארווס סאפיאן - פוסיליס
                                קוויס, אקווזמן קוואזי במר מודוף</p>
                            <p>ורם איפסום דולור סיט אמט, קונסקטורר אדיפיסינג אלית גולר מונפרר סוברט לורם שבצק יהול, לכנוץ
                                בעריר גק ליץ, נולום ארווס סאפיאן - פוסיליס קוויס, אקווזמן לורם איפסום דולור סיט אמט,
                                קונסקטורר אדיפיסינג אלית</p>
                            <span>?למה אנחנו</span>
                            <ul>
                                <li>
                                    <span style="background-image: url('img/service.png')"></span>
                                    100% שירות
                                </li>
                                <li>
                                    <span style="background-image: url('img/repair.png')"></span>
                                    הבחון תקלה מתקדם
                                </li>
                                <li>
                                    <span style="background-image: url('img/price.png')"></span>
                                    מחירים אטורקטיביים
                                </li>
                                <li>
                                    <span style="background-image: url('img/quality.png')"></span>
                                    איכות המוצר
                                </li>
                            </ul>
                        </div>
...
<link rel='stylesheet' id='main-style-css' href='/css/index.css' type='text/css' media='all'/>
</body>
</html>
